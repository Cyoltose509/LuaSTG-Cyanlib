...
function GrazerClass:render()
    ...
    Render.SetSpriteState(center, Render.BlendMode.Default, self.lh * 255, 255, 255, 255)
    Render.SimpleSprite(center, self.x, self.y, 0, size)
    Render.SetSpriteState(aura, Render.BlendMode.Default, 255, 255, 255, 255)
    Render.SimpleSprite(aura, self.x, self.y, -self.aura + self.aura_d, self.lh * size)
    Render.SetSpriteState(aura, Render.BlendMode.Default, self.lh * 255, 255, 255, 255)
    Render.SimpleSprite(aura, self.x, self.y, self.aura, (2 - self.lh) * size)
