...
function M:setupDefaultStates(options)
    ...
    sm:registerState("idle_left", {
      ...
      :addTransition("idle_right", "move_right_enter", function(ctx)
        local dx = ctx.owner.obj.dx or 0
        local cast = ctx.owner.obj.cast or 0
        return dx > moveThreshold and cast <= 0
    end)
      ...
      :addTransition("idle_right", "move_left_enter", function(ctx)
        local dx = ctx.owner.obj.dx or 0
        local cast = ctx.owner.obj.cast or 0
        return dx < -moveThreshold and cast <= 0
    end)
      ...
      :addTransition("cast_loop", "cast_exit", function(ctx)
        local cast = ctx.owner.obj.cast or 0
        return cast <= 0
    end)
...
--- wisys:setupLegacyWalkImage("texture", 10, 4, {9, 5, 5, 10}, {3, 3, 4}, 6)
--- ```
function M:setupLegacyWalkImage(texture, nCol, nRow, images, anis, interval, a, b)
    if a then
        b = b or a
        self.obj.a = a
        self.obj.b = b
    ...
    local texW, texH = lstg.GetTextureSize(texture)
