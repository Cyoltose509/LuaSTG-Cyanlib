...
function M.LoadImage(name, path, h, l1, l2, l3)
    ...
    local imgs = {}
    Core.Lib.Table.Concat(imgs, Sprite.NewGroup(name .. 1, tex, 0, 0, l1, h, 1, 16))
    Core.Lib.Table.Concat(imgs, Sprite.NewGroup(name .. 2, tex, l1, 0, l2, h, 1, 16))
    Core.Lib.Table.Concat(imgs, Sprite.NewGroup(name .. 3, tex, l1 + l2, 0, l3, h, 1, 16))
