...
require("Core.Render.Color")
require("Core.Render.Sprite")
require("Core.Render.Draw")
require("Core.Render.Mesh")
require("Core.Render.Skybox")

require("Core.Render.GPU")
require("Core.Render.Ball")
require("Core.Render.Text")

require("Core.Render.Utils")
setmetatable(M, {
